/*(function($) {
 ...
 function menu() {
 $('.header-menu-button').on('tap', function(e) {
 e.preventDefault();
 ...
 function tapNext() {
 $('.program-blocks-slides-nav-next').on('tap', function(e) {
 e.preventDefault();
 toNext();
 });
 }
 ...
 function tapPrev() {
 $('.program-blocks-slides-nav-prev').on('tap', function(e) {
 e.preventDefault();
 toPrev();
 });
 }
 ...
 function tapNext() {
 $('.comercial-pannel-nav.next').on('tap', function(e) {
 e.preventDefault();
 ...
 function tapPrev() {
 $('.comercial-pannel-nav.prev').on('tap', function(e) {
 e.preventDefault();
 ...
 function signin() {
 $('.open-signin-alert').on('tap', function(e) {
 e.preventDefault();
 ...
 $('.close-signin-alert').on('tap', function(e) {
 e.preventDefault();
 ...
 function signup() {
 $('.open-signup-form').on('tap', function(e) {
 e.preventDefault();
 ...
 $('.close-signup-form').on('tap', function(e) {
 e.preventDefault();
 ...
 function thumbs() {
 $('.recipe-slides-thumbs').find('.thumb').on('tap', function(e) {
 e.preventDefault();
...
//        var custom_event = $.support.touch ? "tap" : "click";
        var custom_event = ('ontouchstart' in window ? 'touchend' : 'click');
        ...
        function home() {
            $(".home-pannel-slides .slide").width($(window).width());

            $(".home-pannel-slides").carouFredSel({
                responsive: true,
                auto: false,
                scroll: {
                    fx : "fade",
                ...
                prev: {
                    button: ".home-pannel .prev"
                },
                next: {
                    button: ".home-pannel .next"
                }
            });
            // function pannel() {
            //     var pannel_width = $('.home-pannel').width();
        ...
        $(".scroll-link").click(function() {
            scrollToID(".lt-programs-widget", 400);
        })
