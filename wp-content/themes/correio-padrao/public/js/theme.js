(function($) {
    ...
    $('#whatsapp-sharrre').sharrre({
        share: {
            whatsapp: true
        },
        template: '<a class="link" href="javascript:;" title="Compartilhe no Whatsapp"><i class="icon whatsapp"><img src="'+theme_base+'/public/img/icon-whatsapp.svg" alt="Whatsapp"></i></a>',
        enableHover: false,
        click: function(api, options){
            api.simulateClick();
