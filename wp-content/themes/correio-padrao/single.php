                            ...
                            <li id="whastapp-sharrre" data-url="<?php the_permalink(); ?>" data-text="<?php the_title_attribute(); ?>" class="item">
                                <a class="link" href="whatsapp://send?text=<?php the_title(); ?>: <?php the_permalink(); ?>" title="Compartilhe no Whastapp">
                                    <i class="icon whatsapp">
                                        <img src="http://jobs.qualitare.com/correio/jornal-da-correio/wp-content/themes/correio-padrao/public/img/icon-whatsapp.svg" alt="whastapp">
                                    </i>
                                </a>
                            </li>
                        </ul>
                        <p class="author v-middle">Por: <?php echo get_the_author(); ?></p>
                    </div>
                </header>
