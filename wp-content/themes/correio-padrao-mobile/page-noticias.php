...
<section class="wrapper archive">
    ...
    <section class="content archive-content">
        ...
        $the_query = new WP_Query('post_type=post&posts_per_page=8&paged=' . $paged);
        ?>
                ...
                <?php if (has_post_thumbnail()) { ?>
                    ...
                    <?php } else { ?>
                        ...
                        <div class="archive-info v-middle" style="border-bottom-color: <?php echo get_ms_theme_mod('color_setting', '#000', get_post_meta(get_the_ID(), 'blogid', true)); ?>;">
                            ...
                            ?>
                            <a class="lt-headline-label" href="<?php the_permalink(); ?>" title="<?php echo $category->name; ?>" style="background:<?php echo get_ms_theme_mod('color_setting', '#000', get_post_meta(get_the_ID(), 'blogid', true)); ?>;"><?php echo $category->name; ?></a>
